...
class MessagingExpert:
    ...
    def __init__(self, sentiment_analyzer, use_gpt=False, openai_client=None, weather_api=None, news_api=None):
...
class ExpertSystem:
    ...
    def __init__(self, sentiment_analyzer, use_gpt=False, openai_client=None, weather_api=None, news_api=None):
        self.messaging_expert = MessagingExpert(sentiment_analyzer, use_gpt, openai_client, weather_api, news_api)
